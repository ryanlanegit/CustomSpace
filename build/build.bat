...
REM
REM    ECHO ************************************************ >> built.log
REM    ECHO Building \CustomSpace\Scripts\serviceCatalog\roTaskMain.js >> built.log & cls & type built.log
...
REM
REM    ECHO ************************************************ >> built.log
REM    ECHO Building \CustomSpace\Scripts\page\pageTaskMain.js >> built.log & cls & type built.log
